...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    allControls: "altPrev,pageNumber,altNext,play,outline,thumbnail,zoomIn,zoomOut,fullScreen,share,download,more,pageMode,startPage,endPage,sound,close",
    moreControls: "download,pageMode,startPage,endPage,sound,close",
    hideControls: "",
...
var DFLightBox = (function DFLightBoxClosure($) {
  ...
  function DFLightBox(closeCallback, options) {
    ...
    _this.closeButton = $("<div>").addClass("df-ui-btn df-ui-close")
      .on("click", function () {
